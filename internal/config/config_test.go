...
func TestValidateErrorMessages(t *testing.T) {
	tests := []struct {
		...
		// "prod environment with INTERCOM_JWT_SECRET set" test removed - JWT is now from Auth0 Action
		{
		...
		// IntercomJWTTTL validation tests removed - JWT is now generated by Auth0 Action
	}
